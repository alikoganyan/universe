...
import {
  BackIcon, AddIcon, SearchIcon, CloseIcon
} from '../../assets/index';
...
const {
  sidePadding, HeaderHeight, fontSize, HeaderHeightInner
} = helper;
        ...
        <Left>
          {!search
            ...
            : (
              <>
                <SearchIcon />
                <Input placeholder="поиск" value={find} onChangeText={this.find} autoFocus />
              </>
            )
                    }
        </Left>
