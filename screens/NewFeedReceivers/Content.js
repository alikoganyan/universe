...
import {
  View, Text, SafeAreaView, FlatList, Image, TouchableOpacity, ScrollView, Dimensions, KeyboardAvoidingView, InteractionManager
} from 'react-native';
...
участников
    ...
    addReceiver = (e) => {
      const {
        addReceiver, back, setReceivers, receivers
      } = this.props;
    ...
    addAllReceivers = (e) => {
      const {
        addReceiver, back, receivers, setReceivers
      } = this.props;
