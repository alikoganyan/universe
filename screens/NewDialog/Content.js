...
import {
  View, Text, SafeAreaView, Image, TouchableOpacity, ScrollView, Dimensions
} from 'react-native';
...
import {
  getMessages, setRoom, addMessage, setCurrentChat
...
class Content extends Component {
  render() {
    ...
    toChat = (event) => {
      const {
        setCurrentDialogs, navigate, getMessages, setRoom, dialog
      } = this.props;
