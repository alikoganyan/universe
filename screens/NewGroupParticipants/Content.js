...
import {
  View, Text, SafeAreaView, FlatList, Image, TouchableOpacity, ScrollView, Dimensions, KeyboardAvoidingView, TouchableWithoutFeedback, InteractionManager
} from 'react-native';
...
class Content extends Component {
  render() {
    ...
    const {
      users, collapsed, options, groups, isSelected, usersToAdd, animationCompleted
    } = this.state;
                                      ...
                                      {animationCompleted
                                        ? (
                                          <BoxInner>
                                            {
                                                    e.workers.map((e, i) => (
                                                      <TouchableWithoutFeedback key={e._id} onPress={() => this.addReceiver(e)}>
                                                        <BoxInnerItem>
                                                          {
                                                                this.includes(e)
                                                                  ? (
    ...
    addReceiver = (e) => {
      const {
        addReceiver, back, setReceivers, participants
      } = this.props;
    ...
    addAllReceivers = (e) => {
      const {
        addReceiver, back, participants, setReceivers
      } = this.props;
