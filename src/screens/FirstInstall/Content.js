...
export default class Content extends Component {
  render() {
    return (
      <Wrapper>
        <FirstTime>
          <Header>Первый раз?</Header>
          <IntroIcon size={150} />
          <FirstTimeText>
            Pariatur consectetur Lorem est irure et in ullamco. Proident
            pariatur labore aliquip fugiat ullamco sunt non. Laborum mollit
            velit amet
          </FirstTimeText>
          <Button onPress={this.goSignup} background={blue} color="#fff">
            Зарегистрируйтесь
          </Button>
        </FirstTime>
        <Dots>
